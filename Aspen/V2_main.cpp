...
int main() {
    City* l[5];
    l[0] = new City("ef",1,1,1,1,1);
    l[0]->setWeightScore(76543);
    l[1] = new City("ij",1,1,1,1,1);
    l[1]->setWeightScore(675432);
    l[2] = new City("cd",1,1,1,1,1);
    l[2]->setWeightScore(12345);
    l[3] = new City("gh",1,1,1,1,1);
    l[3]->setWeightScore(124567);
    l[4] = new City("ab",1,1,1,1,1);
    l[4]->setWeightScore(10);
    mergeSort(l, 0, 4);
    for(City* elem:l)
